...
def k_distil_finetuning(config):
    # ===============================================
    # ------------- Device Strategy Setup -----------
    #
    # Detect available GPUs
    ...
    try:      
        ...
        # Change the above line to `best_weight` when checking the student model.
        print(f"\nSearching pre-trained weights in: {path_to_weight}...")
...
def main():
    ...
    if args.loss == "contrastive":
        ...
        k_distil_finetuning(config)
    else:
        print("\nInvalid loss function specified. Please choose either 'contrastive' or 'k_distil'.\n")
        return
