...
def main():
    ...
    # =========================================================
    parser.add_argument('--loss', type=str, required=True, help='Provide the loss function as contrastive.')
    ...
    if args.loss == "contrastive":
        ...
        print("\nError: Unsupported loss function specified. Use 'contrastive'.\n")
